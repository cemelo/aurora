<Card class='standard-light grid grid-cols-3 grid-rows-2 p-2'>
  <h3 class='col-start-1 col-end-3 text-base font-medium'>Standard Light</h3>
  ...
  <div class='flex items-center justify-end col-start-3 col-end-4 row-start-1 row-end-3'>
    <button on:click={togglePower} class='power-button flex items-center justify-center rounded-md w-4/5 h-full'>
...
<script lang='ts'>
  ...
  import { LightStatus } from '$lib/devices/lights/LightStatus';
